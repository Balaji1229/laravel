...
<html lang="en">
    <head>
        ...
        <!-- App favicon -->
        <link href="{{asset('assets/img/favi-icon.png')}}" rel="icon">
    ...
    <body data-sidebar="dark">
            ...
            <div class="navbar-custom">
                <ul class="list-unstyled topnav-menu float-right mb-0">
                            ...
                            <div class="slimscroll noti-scroll">
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item active">
                                    <div class="notify-icon">
                                        <img src="{{asset('assets/img/users/user-1.jpg')}}" class="img-fluid rounded-circle" alt="" /> </div>
                                ...
                                <a href="javascript:void(0);" class="dropdown-item notify-item">
                                    <div class="notify-icon">
                                        <img src="{{asset('assets/img/users/user-4.jpg')}}" class="img-fluid rounded-circle" alt="" /> </div>
                    ...
                    <li class="dropdown notification-list">
                        <a class="nav-link dropdown-toggle nav-user mr-0 waves-effect" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                            <img src="{{asset('assets/img/users/user-1.jpg')}}" alt="user-image" class="rounded-circle">
                ...
                <div class="logo-box">
                    <a href="index.html" class="logo logo-dark text-center">
                        <span class="logo-lg">
                            <img src="{{asset('assets/img/logo-dark.png')}}" alt="" height="16">
                        </span>
                        <span class="logo-sm">
                            <img src="{{asset('assets/img/logo-sm.png')}}" alt="" height="24">
                        </span>
                    </a>
                    <a href="index.html" class="logo logo-light text-center">
                        <span class="logo-lg">
                            <img src="{{asset('assets/img/logo-light.png')}}" alt="" height="16">
                        </span>
                        <span class="logo-sm">
                            <img src="{{asset('assets/img/logo-sm.png')}}" alt="" height="24">
                        </span>
            ...
            <div class="left-side-menu">
                ...
                <div class="slimscroll-menu">
                    ...
                    <div class="user-box text-center">
                        <img src="{{asset('assets/img/users/user-1.jpg')}}" alt="user-img" title="Mat Helme" class="rounded-circle img-thumbnail avatar-md">
                        <div class="dropdown">
                        ...
                        <div class="row">
                                ...
                                <div class="card-box widget-user">
                                    <div class="media">
                                        <div class="avatar-lg mr-3">
                                            <img src="{{asset('assets/img/users/user-3.jpg')}}" class="img-fluid rounded-circle" alt="user">
                                        </div>
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card-box widget-user">
                                    <div class="media">
                                        <div class="avatar-lg mr-3">
                                            <img src="{{asset('assets/img/users/user-2.jpg')}}" class="img-fluid rounded-circle" alt="user">
                                        </div>
                                        <div class="media-body overflow-hidden">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card-box widget-user">
                                    <div class="media">
                                        <div class="avatar-lg mr-3">
                                            <img src="{{asset('assets/img/users/user-1.jpg')}}" class="img-fluid rounded-circle" alt="user">
                                        </div>
                                        <div class="media-body overflow-hidden">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card-box widget-user">
                                    <div class="media">
                                        <div class="avatar-lg mr-3">
                                            <img src="{{asset('assets/img/users/user-10.jpg')}}" class="img-fluid rounded-circle" alt="user">
                                        </div>
                                        <div class="media-body overflow-hidden">
                                ...
                                <div class="card-box">
                                    ...
                                    <div class="inbox-widget">
                                        ...
                                        <div class="inbox-item">
                                            <a href="#">
                                                <div class="inbox-item-img"><img src="{{asset('assets/img/users/user-1.jpg')}}" class="rounded-circle" alt=""></div>
                                        ...
                                        <div class="inbox-item">
                                            <a href="#">
                                                <div class="inbox-item-img"><img src="{{asset('assets/img/users/user-2.jpg')}}" class="rounded-circle" alt=""></div>
                                        ...
                                        <div class="inbox-item">
                                                <a href="#">
                                                <div class="inbox-item-img"><img src="{{asset('assets/img/users/user-3.jpg')}}" class="rounded-circle" alt=""></div>
                                        ...
                                        <div class="inbox-item">
                                            <a href="#">
                                                <div class="inbox-item-img"><img src="{{asset('assets/img/users/user-4.jpg')}}" class="rounded-circle" alt=""></div>
                                        ...
                                        <div class="inbox-item">
                                            <a href="#">
                                                <div class="inbox-item-img"><img src="{{asset('assets/img/users/user-5.jpg')}}" class="rounded-circle" alt=""></div>
        ...
        <div class="right-bar">
            ...
            <div class="slimscroll-menu">
                ...
                <div class="p-3">
                    ...
                    <div class="mb-2">
                        <img src="{{asset('assets/img/layouts/light.png')}}" class="img-fluid img-thumbnail" alt="">
                    </div>
                    ...
                    <div class="mb-2">
                        <img src="{{asset('assets/img/layouts/dark.png')}}" class="img-fluid img-thumbnail" alt="">
                    </div>
                    <div class="custom-control custom-switch mb-3">
                    ...
                    <div class="mb-2">
                        <img src="{{asset('assets/img/layouts/rtl.png')}}" class="img-fluid img-thumbnail" alt="">
                    </div>
                    <div class="custom-control custom-switch mb-3">
                    ...
                    <div class="mb-2">
                        <img src="{{asset('assets/img/layouts/dark-rtl.png')}}" class="img-fluid img-thumbnail" alt="">
                    </div>
        ...
        <!-- Vendor js -->
        <script src="{{asset('assets/js/js/vendor.min.js')}}"></script>
        ...
        <!-- App js -->
        <script src="{{asset('assets/js/js/app.min.js')}}"></script>
